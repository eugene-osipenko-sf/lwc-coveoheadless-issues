...
export declare type FacetType = 'specific' | 'dateRange' | 'numericalRange' | 'hierarchical';
export interface SortCriteria<T extends 'score' | 'alphanumeric' | 'ascending' | 'descending' | 'occurrences' | 'automatic'> {
