...
export declare const categoryFacetSortCriteria: readonly ["alphanumeric", "occurrences"];
export declare type CategoryFacetSortCriterion = typeof categoryFacetSortCriteria[number];
