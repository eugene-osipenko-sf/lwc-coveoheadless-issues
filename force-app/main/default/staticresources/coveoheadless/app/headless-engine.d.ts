import { Unsubscribe, ThunkDispatch, AnyAction, Dispatch, ReducersMapObject, StateFromReducersMapObject, Middleware } from '@reduxjs/toolkit';
import { Store, ThunkExtraArguments } from './store';
import { SearchAppState } from '../state/search-app-state';
import { AnalyticsClientSendEventHook } from 'coveo.analytics/dist/definitions/client/analytics';
import { Logger, LogEvent, LevelWithSilent } from 'pino';
...
export declare type LogLevel = LevelWithSilent;
/**
...
declare type EngineDispatch<State> = ThunkDispatch<State, ThunkExtraArguments, AnyAction> & Dispatch<AnyAction>;
...
export declare class HeadlessEngine<Reducers extends ReducersMapObject> implements Engine<StateFromReducersMapObject<Reducers>> {
    ...
    get store(): import("@reduxjs/toolkit").EnhancedStore<any, AnyAction, Middleware<{}, any, Dispatch<AnyAction>>[]>;
    get dispatch(): EngineDispatch<StateFromReducersMapObject<Reducers>>;
    get subscribe(): (listener: () => void) => Unsubscribe;
    get state(): StateFromReducersMapObject<Reducers>;
    private accessTokenRenewalsAttempts;
